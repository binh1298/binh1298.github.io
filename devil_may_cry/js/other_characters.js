function changeOthersDescription(des){
  ...
  var modelIDs = [
    document.getElementById("marry-model"),
    document.getElementById("vergil-model"),
    document.getElementById("trish-model")
  ]
  ...
  for(var i = 0; i < 3; i++)
  {
    if(i != des) modelIDs[i].style.opacity = "0.4";
  }
  setTimeout(
    function setOpacity(){
